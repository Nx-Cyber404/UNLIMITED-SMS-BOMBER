...
def update():
    ...
    os.system("cd .. && cd ToxicBomber && python SMS-BOMBER.py")
...
def logo():
    ...
    print("\033[94m│ \033[95mAuthor : Md Omar Faruk                   \033[94m│".center(columns+15))
    print("│ \033[95mTool   : Unlimited SMS Bomber          \033[94m│".center(columns+9))
    print("│ \033[95mGitHub : https://github.com/PAID-X-TOOL \033[94m│".center(columns+9))
    print("│ \033[95mCoder  : Md Omar Faruk          \033[37mV3.0 \033[94m│".center(columns+15))
    print("\033[94m└────────────────────────────────────────┘".center(columns+5))
